    ...
    fn wallet_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("airdrop")
                .about("Request GOR from a faucet")
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The airdrop amount to request, in GOR"),
                )
                .arg(pubkey!(
                    Arg::with_name("to")
                        .index(2)
            ...
            SubCommand::with_name("balance")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display balance in lamports instead of GOR"),
                ),
        )
        .subcommand(
            ...
            SubCommand::with_name("transfer")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send, in GOR; accepts keyword ALL"),
                )
                .arg(pubkey!(
                    Arg::with_name("from")
                        .long("from")
